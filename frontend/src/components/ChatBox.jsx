...
import AuthComponent from "./auth/AuthComponents" // Make sure this path is correct
      ...
      <aside className="w-64 bg-gradient-to-b from-gray-50 to-gray-100 border-r border-gray-200 p-4 space-y-6 h-full shadow-sm">
        ...
        <div className="pt-4 border-t border-gray-200 relative ">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-700 truncate">Logout</p>
            </div>
