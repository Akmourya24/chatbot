...
const InputBar = ({ value, onChange, onSend, onImageSelect, onVoiceMessage, disabled = false, placeholder = "Type your message..." }) => {
  ...
  return (
    <div className="border-t border-gray-200 bg-white p-4">
      ...
      <div className={`flex items-end gap-3 bg-gray-50 rounded-2xl px-4 py-3 transition-all duration-200 ${
        isFocused ? 'ring-2 ring-blue-500 ring-opacity-20 bg-white shadow-sm' : 'hover:bg-gray-100'
      }`}>
